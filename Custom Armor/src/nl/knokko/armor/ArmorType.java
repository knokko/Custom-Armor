...
public enum ArmorType {
	...
	GOLD(GOLD_BOOTS, GOLD_LEGGINGS, GOLD_CHESTPLATE, GOLD_HELMET),
	...
	public static ArmorType fromMaterial(Material material){
		...
		case GOLD_BOOTS : return GOLD;
		case GOLD_LEGGINGS : return GOLD;
		case GOLD_CHESTPLATE : return GOLD;
		case GOLD_HELMET : return GOLD;
